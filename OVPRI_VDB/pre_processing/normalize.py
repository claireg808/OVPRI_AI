...
def clean(text, regex_lines):
    ...
    text = re.sub(r'\n{5,}|\s{5,}', '\n\n\n', text)
    # normalize extra spacing of checklist items
    text = re.sub(r'\n{2,}\s', '\n', text)
...
if __name__ == '__main__':
    ...
    # I/O folders
    input_folder = '/home/gillaspiecl/OVPRI_VDB/data/HRPP_text'
    output_folder = '/home/gillaspiecl/OVPRI_VDB/data/HRPP_normalized'
